...
chmod 770 "$WIRETIDE_DIR"  # SQLite moet kunnen schrijven (journal/wal)
...
### (Agent-bundling, Nginx-config en systemd-service blijven zoals je huidige versie) ###
# ... (rest van script ongewijzigd, behalve dat Wiretide-service altijd draait als $SERVICE_USER)
